    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            path: "user-info",
            async lazy() {
              const { default: UserInfo, action } =
                await import("@/views/user/user-info.tsx");
          ...
          },
          {
            path: "user-avatar",
            async lazy() {
              const { default: UserAvatar, action } =
                await import("@/views/user/user-avatar.tsx");
          ...
          },
          {
            path: "user-pwd",
            async lazy() {
              const { default: UserPassword, action } =
                await import("@/views/user/user-password.tsx");
